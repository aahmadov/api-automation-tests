...
public class PutScenarioTest extends TestBase {
    ...
    @Test(testName = "Put scenario", groups = {"Regression81"})
    public void putScenarioForRegistrySettings_81() throws InterruptedException {
        System.out.println("Test case name: " + testName);
        Map<String, String> data = JsonUtils.getDataBasedOnTestCaseName81(testName);
        assert data != null;

        Response response = RestRequestUtils.putScenario81(data.get("put_call_Url"));
        ...
        Response inboundFaxwithCoverPage = Second_RestRequestUtils.inbound_FaxwithCoverPage81(
        ...
        do {
            ...
            outboundWithCoverPage = Second_RestRequestUtils.getOutboundWithCoverPage81(
        ...
        Response inboundResponse = Second_RestRequestUtils.getInboundWithCoverPage1_81(
                data.get("inboundFax_url") + data.get("newInboundParam"), data.get("credentialNewInbound"));
    ...
    @Test(testName = "Put scenario", groups = {"Regression46"})
    public void putScenarioForRegistrySettings_46() throws InterruptedException {
        System.out.println("Test case name: " + testName);
    ...
    @Test(testName = "Put scenario", groups = {"Regression1FailedneedToTest"})
