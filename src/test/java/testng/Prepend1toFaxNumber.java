...
public class Prepend1toFaxNumber extends TestBase {
    ...
    @Test(testName = "Prepend 1 to fax number if it starts with [2-9]", groups = {"smoke81"})
    public void add_1_to_the_beginning_Of_number81_smoke() throws Exception {
        System.out.println("Test case name: " + testName);
    ...
    @Test( priority=1 ,testName = "Set replixdb.settings table sendfax.prepend1toDestNumber to 0.  Send a fax with a fax number that does not start with ‘1',", groups = {"Regression"})
    ...
    @Test( priority=2 ,testName = "Set replixdb.settings table sendfax.prepend1toDestNumber to 0.  Send a fax with a fax number that does not start with ‘1',", groups = {"Regression"})
...
//            }
    ...
    @Test( testName = "Set replixdb.settings table sendfax.prepend1toDestNumber to 0.  Send a fax with a fax number that does not start with ‘1',", groups = {"Regression81"})
