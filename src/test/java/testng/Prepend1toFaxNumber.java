...
public class Prepend1toFaxNumber extends TestBase {
    ...
    @Test(testName = "Prepend 1 to fax number if it starts with [2-9]", groups = {"RegressionAb"})
    ...
    @Test(testName = "Prepend 1 to fax number if it starts with [2-9]", groups = {"Regression1"})
    public void add_1_to_the_beginning_Of_numberCopy() throws Exception {
        System.out.println("Test case name: " + testName);
        Map<String, String> data = JsonUtils.getDataBasedOnTestCaseName(testName);
        assert data != null;
