...
public class Lookup_Dept_DID_up_to_3_times extends TestBase {
    @Test(priority = 1,testName = "VerifyCallingPartyNumber", groups = {"Regression81"})
    void Verify_CallingPartyNumber_is_user_DID_81() throws Exception {
         ...
         * */
        Response responseReceiveFax2 = RestRequestUtils.responseRecieveFax81(data.get("get_call_Url"), data.get("credentialOutbound"));
    ...
    @Test(priority = 2,testName = "VerifyCallingPartyNumber", groups = {"Regression81"})
    void Verify_CallingPartyNumber_is_user_DID_Regression_81() throws Exception {
        System.out.println("Test case name: " + testName);
        Map<String, String> data = JsonUtils.getDataBasedOnTestCaseName81(testName);
        assert data != null;
    ...
    @Test(priority = 3,testName = "VerifyCallingPartyNumber", groups = {"Regression81"})
    void Verify_CallingPartyNumber_is_user_DID_test1_81() throws Exception {
        System.out.println("Test case name: " + testName);
        Map<String, String> data = JsonUtils.getDataBasedOnTestCaseName81(testName);
        assert data != null;
    ...
    @Test(priority = 1,testName = "VerifyCallingPartyNumber", groups = {"Regression46"})
    void Verify_CallingPartyNumber_is_user_DID_46() throws Exception {
        System.out.println("Test case name: " + testName);
    ...
    @Test(priority = 2,testName = "VerifyCallingPartyNumber", groups = {"Regression46"})
    void Verify_CallingPartyNumber_is_user_DID_Regression_46() throws Exception {
        System.out.println("Test case name: " + testName);
        Map<String, String> data = JsonUtils.getDataBasedOnTestCaseName46(testName);
        assert data != null;
        ...
        //Execute first query
        String database=String.format("select CallingPartyNumber from auto1.sendstatus where (JobID='%s')",JobID);
        DataBaseUtility.executeSQLQueryAuto46(database);
        System.out.println(database);

    }
    @Test(priority = 3,testName = "VerifyCallingPartyNumber", groups = {"Regression46"})
    void Verify_CallingPartyNumber_is_user_DID_test1_46() throws Exception {
        System.out.println("Test case name: " + testName);
        Map<String, String> data = JsonUtils.getDataBasedOnTestCaseName46(testName);
        assert data != null;
