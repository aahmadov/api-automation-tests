...
public class Conversion_archive extends TestBase {
    ...
    void conversion_archive_per_realm_and_per_realm_user_81() throws Exception {
        ...
        Response response1 = RestRequestUtils.putScenario81(data.get("put_call_Url1"));
    ...
    @Test(priority = 1, testName = "Conversion archive per realm and per realm/user", groups = {"Regression8114"})
