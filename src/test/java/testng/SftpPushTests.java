...
//        Thread.sleep(1000*60);
    ...
    @Test(priority = 1, testName = "SFTP - Test Simple Authentication", groups = {"Regression81test"})
    ...
    @Test(priority = 3, testName = "SFTP - Test With Certificate No Passphrase", groups = {"Regression81test"})
