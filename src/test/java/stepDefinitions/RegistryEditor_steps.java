...
public void i_want_to_write_a_step_to_change_registryEditor() throws IOException, InterruptedException  {
	...
	ProcessBuilder builder = new ProcessBuilder(new String[] {"cmd", "/c","regedit","/s","c:/Users/Administrator/Desktop/blank.reg"});
	
	//Desktop.getDesktop().open(new File("c:/Users/abbas/Desktop/10.reg"));
